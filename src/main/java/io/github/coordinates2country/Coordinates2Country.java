...
public class Coordinates2Country {
    ...
    private static String country(double latitude, double longitude, boolean wikidataOrNot) {
        ...
        InputStream inputStream = Coordinates2Country.class.getResourceAsStream("/countries-8bitgray.png");
     ...
     */
    private static String nearestCountry(int x, int y, boolean wikidataOrNot, Bitmap bitmap) {
